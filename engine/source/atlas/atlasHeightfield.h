...
#ifndef _ATLASHEIGHTFIELD_H_
#define _ATLASHEIGHTFIELD_H_
...
public:
    ...
    AtlasHeightfield(const U32 sizeLog2, const F32 sampleSpacing, const F32 heightScale);
    virtual ~AtlasHeightfield();
    ...
    {
        AssertFatal(mNormal, "AtlasHeightfield::getNormal - no normal array!");
