...
public:
    ...
    Point3F& operator=(const Point4F&);
...
public:
    ...
    Point4F& operator=(const Point3F& _vec);
...
inline Point3F& Point3F::operator=(const Point4F& _vec)
{
    x = _vec.x;
    y = _vec.y;
    z = _vec.z;
...
inline Point4F& Point4F::operator+=(const Point3F& _add)
{
    x += _add.x;
    y += _add.y;
    z += _add.z;
