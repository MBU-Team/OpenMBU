...
#ifdef TORQUE_NET_STATS
            obj->getClassRep()->updateNetStatPack(0xFFFFFFFF, bstream->getCurPos() - beginSize);
#endif
        }
    }
...
#ifdef TORQUE_NET_STATS
            object->getClassRep()->updateNetStatPack(0xFFFFFFFF, bstream->getCurPos() - beginSize);
#endif
        }
    }
...
#ifdef TORQUE_NET_STATS
            object->getClassRep()->updateNetStatUnpack(bstream->getCurPos() - beginSize);
#endif
            validObject = true;
        }
        else
