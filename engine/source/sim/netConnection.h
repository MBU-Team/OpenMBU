...
struct ConnectionParameters
{
    ...
    Vector<const NetAddress*> mPossibleAddresses; ///< List of possible addresses for the remote host in an arranged connection.
...
#ifdef TORQUE_NET_HOLEPUNCHING
    void connectArranged(const Vector<const NetAddress*> &possibleAddresses, bool isInitiator);
#endif
