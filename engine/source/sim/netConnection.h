...
struct ConnectionParameters
{
    ...
    Vector<NetAddress> mPossibleAddresses; ///< List of possible addresses for the remote host in an arranged connection.
...
#ifdef TORQUE_NET_HOLEPUNCHING
    void connectArranged(const Vector<NetAddress> &possibleAddresses, bool isInitiator);
#endif
